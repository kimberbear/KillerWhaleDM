...
1. Download source
2. Zip the contents of CW-DSD- the files inside CW-DSD, not the folder itself -and change it's file extension from ".zip" to ".pk3" 
3. Download Zandronum from the offical website!
